...
def display():
    id_var = 974194701
    label_id['text']=id_var
    name = "Your name"
    label_name['text']=name
    dob = "31 February 2023"
    label_dob['text']=dob
    pin = 123456
    label_pin['text']=pin
    address = "Mars"
    label_address['text']=address
    vehical="10 Wheeler, 2 Wheeler"
    label_vehicle_type['text']=vehical
    
    
# Create a button
button1 = Button(root,text=" Show my driving licence", command=display)
